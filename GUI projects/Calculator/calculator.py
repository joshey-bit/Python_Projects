...
button_sum = Button(root, text='+', padx = 29, pady= 20, command= button_add)
...
button_equal = Button(root, text='=', padx = 29, pady= 20, bg= 'green' ,command=button_equal)
...
button_sum.grid(row=4,column=1,columnspan=1)
button_subtract.grid(row=4,column=2,columnspan=1)
button_multiply.grid(row=5, column=1,columnspan=1)
button_divide.grid(row=5, column=2,columnspan=1)
button_equal.grid(row=5, column=0,columnspan=1)
